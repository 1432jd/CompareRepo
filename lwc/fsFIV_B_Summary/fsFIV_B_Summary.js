            ...
            .then(result => {
                ...
                for (var i = 0; i < _tempVar[0].fieldsContent.length; i++) {
                    ...
                    if (_tempVar[0].fieldsContent[i].fieldAPIName === 'Sourcing_Officer__c') {
                        console.log('Sourcing_Officer__c ',_tempVar[0].fieldsContent[i].value);
                        if (_tempVar[0].fieldsContent[i].value && _tempVar[0].fieldsContent[i].value != ' ')
                            this.fieldOfficerEMPId = _tempVar[0].fieldsContent[i].value;
                    }
                }
