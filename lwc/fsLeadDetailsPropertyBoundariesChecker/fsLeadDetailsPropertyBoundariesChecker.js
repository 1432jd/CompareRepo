...
export default class FsLeadDetailsPropertyBoundariesChecker extends LightningElement {
    @track rowAction = [
        {
            //label: 'Edit',
            type: 'button-icon',
                    ...
                    JSON.parse(result.strDataTableData).forEach(element => {	
                        for (let keyValue of Object.keys(element)) {	
                            if (keyValue != 'Id') {	
                                ...
                                console.log('insideee111 keyValue ',keyValue,value )	
    ...
    getSectionPageContent(recId){
        ...
        getSectionContent({recordIds : recId, metaDetaName : 'Lead_Details_Property_Boundaries_Checker'})
        .then(result => {
