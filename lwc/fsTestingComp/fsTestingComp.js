...
export default class FsTestingComp extends NavigationMixin(LightningElement) {
    ...
    @track lastLoginDate;
    @track getDataArr = ["Login", "Verification", "Lead Detail", "Process Credit", "Approval Credit", "MOD Registration", "Agreement Execution", "Disbursal Maker", "Disbursal Author", "Custody"];
    @track getStagesData = [];
