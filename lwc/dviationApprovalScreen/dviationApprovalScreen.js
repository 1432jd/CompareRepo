...
export default class DviationApprovalScreen extends NavigationMixin(LightningElement) {
    @api applicationId;
    @api stageName;
 ...
 @wire(getTRDeviationRecord, { applicationId: '$applicationId', stageName: '$stageName' })
    wiredDeviations(value) {
        ...
        //Added by Sangeeta : 09-nov-22 : to make decision, remarks and mitigants non editable if stage is PC or DM
        if(this.stageName != null && this.stageName != undefined && this.stageName != ''){
            if(this.stageName == 'Process Credit' || this.stageName == 'Disbursal Maker'){
        ...
        if (isValid) {
            updateDecisions({ deviationList: JSON.stringify(this.trdeviationList) }).then(res => {
                ...
                //refreshApex(this._wiredResult);
                 ...
                 //Added by Sangeeta Yadav : 05 Nov 22 : To redirect to application view page 
