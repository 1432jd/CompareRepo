...
export default class FsLeadDetailsLoanTypeChecker extends LightningElement {
    @api recordId;
    @track fieldsContent;
    ...
    getLoanTypeData() {
        ...
        getSectionContent({ recordIds: this.recordId, metaDetaName: 'Lead_Details_Loan_Type_Checker' })
            .then(result => {
