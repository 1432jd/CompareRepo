...
export default class GenericEditPagesLWC extends LightningElement {
    ...
    */
    ...
    @api refreshData(refreshData) {
        ...
        console.log('GENERIC EDIT ',JSON.stringify(this.dataToDisplay));
    }
    ...
    connectedCallback() {
        ...
        console.log('result #### '+JSON.stringify(this.dataToDisplay))
    ...
    handleKeyUp(evt) {
        ...
        if (isEnterKey) {
            ...
            const selectedEvent = new CustomEvent('enterpressed', { detail: evt.target.value });
            this.dispatchEvent(selectedEvent);
        }
    }
}