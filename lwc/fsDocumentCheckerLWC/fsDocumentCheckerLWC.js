...
import submitApp from '@salesforce/apex/FsCustodyController.submitApp';
//Build 4
import getPendingReasonValidation from '@salesforce/apex/FS_PendingReasonController.getPendingReasonValidation';

export default class FsDocumentCheckerLWC extends NavigationMixin(LightningElement) {
    @api recordId;
    @track lastLoginDate;
    ...
    @track docId;
    @track loanAppName;
    @track stageName ='Document Checker';
    @track disval = false;
...
/* commented to get detail from application: @ Sangeeta yadav : 20 dec 22
    ...
    checkAccess(){
        ...
        this.handleGetLastLoginDate();
                console.log('this.hasAccess the getapp click >>',this.hasAccess);
            }else{
                console.log('else .hasAccess the getapp click >>',this.hasAccess);
            }
        }).catch((err) => {
            this.isSpinner = false;
                   ...
                   // }
                    ...
                    if(result){
                       ...
                       /* if(result.Stage__c == 'VDC Maker'){
                        ...
                        // if(result.Stage__c == 'VDC Checker'){
        ...
        if ((this.tabName === 'VendorHandoff') || (this.tabName === 'VDC' && this.showerrorCheckrId == false && this.showerrorMakerId == false) ) {
            ...
            var tempCourierObject = {
               ...
               // Application_Number__c: this.wrpObj.Application_Number__c,
                ...
                VDC_Checker_Id__c: this.wrpObj.VDC_Checker_Id__c,
    ...
    handleSubmit(){
        ...
        submitApp({ dataWrapper: JSON.stringify(tempCourierObject), DocChecker: DocChecker })
                .then(res => {
