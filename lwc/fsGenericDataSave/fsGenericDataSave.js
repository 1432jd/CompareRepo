    ...
    if (properties && properties.length) {
        ...
        properties.forEach(pro => {
            ...
            if (!pro.Pathway_Available__c || !pro.Pathway_Available__c.trim() || !pro.Boundaries_As_Per_Inspection_Are_Same__c || !pro.Boundaries_As_Per_Inspection_Are_Same__c.trim() ||
                !pro.Mortgage_Property_Area__c || !pro.Mortgage_Property_Area__c.trim() || !pro.Land_Area_Sq_Ft__c || !pro.Land_Area_Sq_Ft__c.trim() ||
...
export function checkValidationLeadDetails() {
    ...
    if (employmentDetails && employmentDetails.length) {
        employmentDetails.forEach(emp => {
            if (!emp.Occupation__c) {
                ...
                errorMsg.push('Complete missing fields inField Officer details are missing in Application Details sub section of Sourcing Details secion.Employment Details sub section of Application Information section');
    ...
    applicationDetails.forEach(currentItem => {
        if (!currentItem.Sourcing_Officer__c) {
