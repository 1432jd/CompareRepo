...
export default class FsDOSLWC extends NavigationMixin(LightningElement) {
    ...
    @wire(getRecord, { recordId: '$recordId', fields: [NAME, DECISION, STAGE] })
    ...
    handleDOSSubmit() {
        ...
        if (this.errorMsgs && this.errorMsgs.length) {
            ...
            if(this.applicationStage == 'Awaiting DOS'){
                fields[STAGE.fieldApiName] = 'Disbursal Author';
            }
