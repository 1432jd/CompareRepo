...
export default class Fiv_Disb_LoanParams extends LightningElement {
    ...
    setFieldNameForAutoPopulate() {
        ...
        console.log('obj param category >>>',this.obj_parent_appt_wrapper_data);
        if (this.obj_parent_appt_wrapper_data.mapExtraParams.hasOwnProperty('ROI_category__c')) {
              this.mapAutoPopulateFieldMapping.set('ROI_category__c', this.obj_parent_appt_wrapper_data.mapExtraParams.ROI_category__c);
        }
    ...
    autoPopulateLoanParameters() {
        ...
        console.log('inside autoPopulateLoanParameters',this.mapAutoPopulateFieldMapping);
        ...
        for (var i = 0; i < _tempVar[0].fieldsContent.length; i++) {
            ...
            if (_tempVar[0].fieldsContent[i].fieldAPIName == 'Loan_Amount_Sanctioned__c') {
                _tempVar[0].fieldsContent[i].value = this.mapAutoPopulateFieldMapping.get(_tempVar[0].fieldsContent[i].fieldAPIName);
            ...
            if (_tempVar[0].fieldsContent[i].fieldAPIName == 'ROI_Category__c') {
                console.log('inside category');
                _tempVar[0].fieldsContent[i].value = this.mapAutoPopulateFieldMapping.get('ROI_category__c');
            }
        }
