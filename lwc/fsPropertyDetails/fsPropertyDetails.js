...
export default class FsPropertyDetails extends LightningElement {
    ...
    @track propWrapper = { loanAppId: '', applicationId: '', propId: '',NatureOfProp: '',PropertyType:'' };
    @track recordId;
        ...
        if (event.detail.ActionName === 'edit') {
            ...
            setTimeout(() => {
                ...
                if (this.template.querySelector("c-fs-pre-login-property-detail")) {
                    ...
                    this.propWrapper.NatureOfProp = recordData.Nature_Of_Property__c;
                    this.propWrapper.PropertyType = recordData.Property_Type__c;
